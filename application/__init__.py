...
def dbbuild():
    ...
    admin2 = User(username='admin2', password='pbkdf2:sha1:1000$X97hPa3g$252c0cca000c3674b8ef7a2b8ecd409695aac370', role=2, email='admin2@163.com', gender='2')
    ...
    admin4 = User(username='admin4', password='pbkdf2:sha1:1000$X97hPa3g$252c0cca000c3674b8ef7a2b8ecd409695aac370', role=4, email='admin4@163.com', gender='2')
