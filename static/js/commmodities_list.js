       ...
       success:function (data) {
          ...
          for (var i = 0;i<data.data.length;i++){
              ...
              html += "<tr>\n" +
                  ...
                  "\t\t\t\t\t\t\t\t\t\t<a class=\"layui-btn layui-btn-sm layui-btn-normal\" title=\"编辑\" onclick=\"execute_open('更新商品状态', 'warehouseUpdateStatus.html?id="+data.data[i].id+"', 1000, 300)\" href=\"javascript:;\"><i class=\"layui-icon layui-icon-edit\"></i>物流二维码</a>\n" +
                  "\t\t\t\t\t\t\t\t\t</td>\n" +
                  "\t\t\t\t\t\t\t\t</tr>"
          }
          $("tbody").append(html);
